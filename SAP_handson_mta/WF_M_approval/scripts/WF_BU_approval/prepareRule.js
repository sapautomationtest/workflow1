...
var user = $.info.startedBy;
$.context.user = user;



var businessUnit = {};
businessUnit.BUKEY = $.context.BuList;
$.context.businessUnit = businessUnit;    // in case of the loop, current BU



//ID  - business key
var requestId = $.context.BuList + $.context.Scenario;
